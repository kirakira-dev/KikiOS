/*
 * TCC for KikiOS - libc declarations
 *
 * Minimal libc for TCC, implemented via kapi.
 */
...
/* Signed integer types (kiki.h only has unsigned) */
typedef signed char int8_t;
typedef signed int int32_t;
typedef signed long int64_t;

/* Additional types not in kiki.h */
...
#define O_BINARY   0x0000  /* No-op on KikiOS */
...
/* Long double versions (use double since we don't have true long double) */
